...
export default function Checkout({ deal }) {
  return (
    <>
      <main
        aria-label="Main"
        class="flex px-8 py-8 sm:px-12 lg:col-span-7 lg:py-12 lg:px-16 xl:col-span-6 bg-gray-100"
      >
        <div class="max-w-xl lg:max-w-3xl">
          ...
          <div className=" rounded-lg border border-gray-200">
            <table class="overflow-visible justify-items-stretch min-w-full divide-y divide-gray-200 text-sm">
          ...
          <form action="#" class="mt-8 grid grid-cols-6 gap-6">
            <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
              ...
              <p class="mt-4 text-sm text-gray-500 sm:mt-0 align-right">
                Powered by RHB Next
              </p>
            </div>
          </form>
